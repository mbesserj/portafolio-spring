...
/**
 * Repositorio para DetalleCosteoEntity - Orientado al motor de costeo Solo
 * incluye operaciones esenciales para el procesamiento de costeos
 */
@Repository
public interface DetalleCosteoRepository extends JpaRepository<DetalleCosteoEntity, Long> {

    /**
     * Busca detalles de costeo por clave de agrupación Utilizado por el motor
     * para encontrar costeos existentes
     */
    List<DetalleCosteoEntity> findByClaveAgrupacion(String claveAgrupacion);

    /**
     * Busca detalles de costeo por transacción de ingreso Para identificar qué
     * egresos se costearon con un ingreso específico
     */
    List<DetalleCosteoEntity> findByIngreso(TransaccionEntity ingreso);

    /**
     * Busca detalles de costeo por transacción de egreso Para identificar con
     * qué ingresos se costeó un egreso específico
     */
    List<DetalleCosteoEntity> findByEgreso(TransaccionEntity egreso);

    /**
     * Elimina todos los detalles de costeo por clave de agrupación Utilizado
     * cuando se recalcula el costeo de un grupo
     */
    ...
    /**
     * Obtiene el costo total por clave de agrupación Utilizado para verificar
     * cálculos del motor
     */
    ...
    /**
     * Obtiene la cantidad total utilizada por clave de agrupación Utilizado
     * para verificar balances del motor
     */
    ...
    /**
     * Obtiene detalles de costeo incompletos Para debugging y mantenimiento del
     * motor
     */
    ...
    /**
     * Encuentra detalles huérfanos (sin transacciones válidas) Para
    ...
    /**
     * Cuenta detalles de costeo por clave de agrupación Para estadísticas del
     * motor
     */
    Long countByClaveAgrupacion(String claveAgrupacion);

    /**
     * Obtiene resumen de costeos por transacción de ingreso Para reportes del
     * motor de costeo
     */
    ...
    @Modifying
    @Query("DELETE FROM DetalleCosteoEntity k WHERE k.instrumento IN :instrumentos")
