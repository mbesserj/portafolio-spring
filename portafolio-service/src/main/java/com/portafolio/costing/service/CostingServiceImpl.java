...
import com.portafolio.costing.engine.FifoCostingEngine;
...
import com.portafolio.mapper.KardexMapper;
        ...
        SaldoKardexEntity saldo = saldoKardexRepository
                ...
                .orElseGet(() -> {
                    ...
                    return SaldoKardexEntity.builder()
                            .empresa(entityManager.getReference(com.portafolio.model.entities.EmpresaEntity.class, empresaId))
                            .custodio(entityManager.getReference(com.portafolio.model.entities.CustodioEntity.class, custodioId))
                            .instrumento(entityManager.getReference(com.portafolio.model.entities.InstrumentoEntity.class, instrumentoId))
                            .cuenta(cuenta)
