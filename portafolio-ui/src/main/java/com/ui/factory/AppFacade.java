...
import com.serv.service.UsuarioService.UserRegistrationResult;
...
public class AppFacade {
    ...
    public ServiceResult<List<TipoMovimientoEntity>> obtenerTodosLosTipos() {
        return executeServiceCall(
                () -> container.getService(TipoMovimientosService.class).obtenerTodosLosTipos(),
                "Error al obtener tipos de movimiento."
        );
    }

    public ServiceResult<List<TipoMovimientoEstado>> obtenerMovimientosConCriteria() {
        return executeServiceCall(
                () -> container.getService(TipoMovimientosService.class).obtenerMovimientosConCriteria(),
    ...
    public ServiceResult<Void> actualizarEstadoContable(Long id, TipoEnumsCosteo nuevoEstado) {
        return executeServiceCall(
                () -> container.getService(TipoMovimientosService.class).actualizarEstadoContable(id, nuevoEstado),
